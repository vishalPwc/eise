package com.aafes.settlement.core.model.settlement;
...
public class SettlementRO {
	...
	private boolean					isAdjustmentInvoicePresent = false;

	/**
	 * @return the isAdjustmentInvoicePresent
	 */
	public boolean isAdjustmentInvoicePresent() {
		return isAdjustmentInvoicePresent;
	}

	/**
	 * @param isAdjustmentInvoicePresent
	 *            the isAdjustmentInvoicePresent to set
	 */
	public void setAdjustmentInvoicePresent(
			boolean isAdjustmentInvoicePresent
	)
	{
		this.isAdjustmentInvoicePresent = isAdjustmentInvoicePresent;
	}

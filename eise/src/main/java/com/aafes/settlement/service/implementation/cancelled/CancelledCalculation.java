 ...
 */
@Service
public class CancelledCalculation
	extends
	BaseCalculation
{

	private static final Logger LOGGER = LogManager
			.getLogger(CancelledCalculation.class);
	...
	{
		LOGGER.debug(
				"The rule for Cancelled is Lowest GC followed by highest and lastly Credit Card."
		);
	...
	{
		p_genericResponse.setCancelledTender(p_InvoiceResponses);
	}

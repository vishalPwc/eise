...
@Service
public class CreditCardAuthImpl
	extends
	BaseAuth
	implements AuthInterface, ErrorConstants, Constants
{
	private static final Logger LOGGER = LogManager
			.getLogger(CreditCardAuthImpl.class);
	...
	public void processReturns(
			...
			String p_openInvoiceId, String p_invoiceType
	)
			throws Exception
	{

...
@Service
public class MLRetailAuthImpl
	extends
	BaseAuth
	implements AuthInterface, ErrorConstants, Constants
{
	private static final Logger LOGGER = LogManager
			.getLogger(MLRetailAuthImpl.class);
	...
	// -----------------------------------------------------------------------------
	/**
	 * This method is used by returns Request and AdjustmentRequest
	 * 
	 * @param p_invoiceLine
			...
			throws Exception
	{
		...
		for (PaymentHeader paymentHeader : l_paymentHeaderList) {
			...
			splitingShipmentAuth(
					...
					l_sortedPaymentMethod, p_authPlan, p_openInvoice
			);
